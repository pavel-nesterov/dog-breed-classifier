...
def get_pet_labels(image_dir):
    ...
    #print("\nEmpty Dictionary results_dic {} items".format(items_in_dic))
    ...
    for filename in filename_list:
        lower_label = filename.lower()
        word_list_pet_image = lower_label.split("_")
        pet_name = ""
    ...
    #    print("\nFilename=", filename, "   Label=", pet_name, ", filenames = ", filenames, "pet_labels = ", pet_labels)
